...
classes_en = ["T-shirt/top", "Trouser", "Pullover", "Dress", "Coat", "Sandal", "Shirt", "Sneaker", "Bag", "Angle boot"]
...
def predict(img):
    ...
    sorted_prob, sorted_indices = torch.sort(y_prob, descending=True) # 恭順にソート
